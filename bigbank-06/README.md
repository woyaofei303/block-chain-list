...
在 [Bank 基础挑战](https://decert.me/quests/c43324bc-0220-4e81-b533-668fa644c1c3) 对应的银行练习之上，按补充题目实现接口、继承与合约管理员，独立于仓库已有的 `bank-05/`。使用 Solidity `0.8.24`，没有第三方合约依赖。在 Remix 中编译、部署和验证，本地目录只保存源码与说明。
